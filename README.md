...
если c[i] = 7, то c[i][j]=(2⋅ex)arcsin(x+618)−−−−−−−−−−−−−√3
;
если c[i] ∈ {9, 11, 15}, то c[i][j]=cos((34/(x+1+12))3)
;
для остальных значений c[i]: c[i][j]=⎛⎝⎜⎜(ln(|x|))(x0.5)3−342/3−−−−−−−−−−−−−−√3⎞⎠⎟⎟0.5⋅⎛⎝⎜⎜⎜⎜⎛⎝⎜⎜⎜⎜23+⎛⎝⎜12⋅x1−arcsin(x+618)⎞⎠⎟arcsin(x+618)⎞⎠⎟⎟⎟⎟2+14⎞⎠⎟⎟⎟⎟
.
